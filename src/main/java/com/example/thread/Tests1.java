...
public class Tests1 extends Thread {

    /**
     * 空中网面试题3： 现有程序同时启动了四个线程去调用TestDo.doSome(key,value)方法；
     * 由于Tests1Do.doSome(key,value)方法内的代码是先暂停1秒，然后再输出以秒为单位的当前时间值，
    ...
    private Tests1Do testDo;
    private String key;
    private String value;

    private Tests1(String key, String key2, String value) {
        this.testDo = Tests1Do.getInstance();
        /*
    ...
    public static void main(String[] args) {
        ...
        Tests1 a = new Tests1("1", "", "1");
        Tests1 b = new Tests1("1", "", "2");
        Tests1 c = new Tests1("3", "", "3");
        Tests1 d = new Tests1("4", "", "4");
...
class Tests1Do {
    private Tests1Do() {}
    private static Tests1Do _instance = new Tests1Do();
    public static Tests1Do getInstance() {
        return _instance;
    }
    //传统写法，没有考虑到线程并发问题
